CREATE OR REPLACE TABLE `tech-chalenge-covid`.pnad_covid_processed.pessoas_092020_processed AS
SELECT
...
FROM
    `tech-chalenge-covid`.pnad_covid_raw.pessoas_092020_raw AS raw
-- JOINs com as tabelas de domínio
